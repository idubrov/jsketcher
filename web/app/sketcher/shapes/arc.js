import { utils as cutils } from '../canvas';
import math from '../../math/math';
import { TOLERANCE, utils } from '../../engine';
import { SketchObject, Ref, EndPoint } from '../canvas';
...
cutils.extend(Arc, SketchObject);
...
Arc.prototype.drawImpl = function(ctx, scale) {
  ...
  var endAngle;
  if (utils.areEqual(this.a.x, this.b.x, TOLERANCE) &&
      utils.areEqual(this.a.y, this.b.y, TOLERANCE)) {
