...
Matrix.prototype.setBasis = function(basis) {
  var b = basis;
...
Matrix.prototype.set3 = function(
    mxx, mxy, mxz,
    myx, myy, myz,
    mzx, mzy, mzz
    ) {
...
Matrix.prototype.set34 = function(
    mxx, mxy, mxz, tx,
    myx, myy, myz, ty,
    mzx, mzy, mzz, tz
    ) {
...
Matrix.prototype.combine = function(transform) {
...
Matrix.prototype._apply = function(vector) {
  return this.__apply(vector, vector);
};

Matrix.prototype.__apply = function(vector, out) {
  var x = vector.x;
  var y = vector.y;
  var z = vector.z;
  return out.set(
